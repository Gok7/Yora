...
public class ExternalLoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedState) {
        ...
        webView.loadUrl(YoraApplication.API_ENDPOINT + "/api/v1/auth/externallogin?provider="
                + service
                + "&response_type=token&client_id=android&redirect_uri=http%3A%2F%2F"
                + YoraApplication.API_ENDPOINT.getHost() + "%2Fmobile-login"
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (uri.getHost().equals(YoraApplication.API_ENDPOINT.getHost()) && uri.getPath()
                        .equals("/mobile-login")) {
