...
public class RegisterGcmFragment extends BaseFragment {
    ...
    private final static String SENDER_ID = "1089345951367";
    private GoogleCloudMessaging cloudMessaging;
    private GcmRegistrationCallback currentCallback;
    private SharedPreferences sharedPreferences;
    private boolean isNewUser;

    public static RegisterGcmFragment get(GcmRegistrationCallback callback, boolean isNewUser,
    ...
    public void onCreate(Bundle savedState) {
        ...
        sharedPreferences = application.getSharedPreferences(RegisterGcmFragment.class.getSimpleName(),
    ...
    @Subscribe
    public void gcmRegistrationUpdated(Account.UpdateUpdateGcmRegistrationResponse response) {
