...
public class MainActivityAdapter extends RecyclerView.Adapter {
    ...
    public int getItemViewType(int position) {
        ...
        throw new IllegalArgumentException("We are being asked for an item type from position " +
                position + " though we have no such item");
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_MESSAGE) {
            final MessageViewHolder viewHolder = new MessageViewHolder(
                    inflater.inflate(R.layout.list_item_message, parent, false));
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ContactRequestViewHolder) {
            ...
            throw new IllegalArgumentException("Cannot populate holder of type "
